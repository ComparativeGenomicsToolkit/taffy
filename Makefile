...
${BINDIR}/stTafTests : ${libTests} ${LIBDIR}/stTaf.a ${stTafDependencies}
	${CC} ${CPPFLAGS} ${CFLAGS} ${LDFLAGS} -o ${BINDIR}/stTafTests ${libTests} ${LIBDIR}/stTaf.a ${stTafLibs} ${LDLIBS}

${BINDIR}/maf_to_taf : maf_to_taf.c ${LIBDIR}/stTaf.a ${stTafDependencies}
	${CC} ${CPPFLAGS} ${CFLAGS} -o ${BINDIR}/maf_to_taf maf_to_taf.c ${LIBDIR}/stTaf.a ${stTafLibs} ${LDLIBS}

${BINDIR}/taf_to_maf : taf_to_maf.c ${LIBDIR}/stTaf.a ${stTafDependencies}
	${CC} ${CPPFLAGS} ${CFLAGS} -o ${BINDIR}/taf_to_maf taf_to_maf.c ${LIBDIR}/stTaf.a ${stTafLibs} ${LDLIBS}

${BINDIR}/taf_norm : taf_norm.c ${LIBDIR}/stTaf.a ${stTafDependencies}
	${CC} ${CPPFLAGS} ${CFLAGS} -o ${BINDIR}/taf_norm taf_norm.c ${LIBDIR}/stTaf.a ${stTafLibs} ${LDLIBS}

${BINDIR}/taf_add_gap_bases : taf_add_gap_bases.c ${LIBDIR}/stTaf.a ${stTafDependencies}
	${CC} ${CPPFLAGS} ${CFLAGS} -o ${BINDIR}/taf_add_gap_bases taf_add_gap_bases.c ${LIBDIR}/stTaf.a ${stTafLibs} ${LDLIBS}
